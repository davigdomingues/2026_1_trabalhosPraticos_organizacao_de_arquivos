...
/**
 * @brief handler de tratamento que lê os critérios de busca e opera em cadeia o processo de remoção lógica 
 * no arquivo de dados e, caso a chave primária seja fornecida, a remoção indexada na Árvore-B
 */
void handleDeleteWhere();

/**
 * @brief handler de tratamento que lê os critérios de busca e opera propriamente a remoção indexada na Árvore-B,
 * além da remoção lógica no arquivo de dados
 */
...
/**
 * @brief insere uma chave e seu ponteiro de dados correspondente na Árvore-B, promovendo chaves e dividindo nós conforme 
 * necessário para manter as propriedades da árvore
 * 
...
/**
 * @brief função recursiva que percorre a Árvore-B para localizar e remover a chave especificada, realizando operações de 
 * empréstimo ou merge conforme necessário para manter as propriedades da árvore
 * 
 * @param fileIndice arquivo de índice da Árvore-B
...
/**
 * @brief trata o underflow em um nó da Árvore-B após uma remoção, realizando empréstimo ou merge conforme necessário para 
 * restaurar as propriedades da árvore
 * 
 * @param fileIndice arquivo de índice da Árvore-B
